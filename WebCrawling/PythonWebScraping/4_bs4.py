...
print(soup.a.get_text()) # a element의 text만 가저옴
...
rank2 = rank3.previous_sibling.previous_sibling # previous_sibling: 이전 element로 넘어감
...
print(ranking)
webtoon = soup.find("a", text="스터디그룹-시즌2 23화")
# text에 해당하는 a태그 찾음
print(webtoon) 
